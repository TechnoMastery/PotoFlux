...
import static net.minheur.potoflux.modGen.GeneratorStageHandler.cancel;

public class ModDataGetterHandler {
    // --- setup vars ---
    ...
    public ModDataGetterHandler(JPanel owner) {
        this.owner = owner;
    }
    ...
    public Set<MainModules> getSelectedModules() {
        return selectedModules;
    }
    public Set<DatagenModules> getSelectedDatagenModules() {
        return selectedDatagenModules;
    }
